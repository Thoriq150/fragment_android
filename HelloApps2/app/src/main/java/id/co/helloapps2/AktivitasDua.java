...
public class AktivitasDua extends AppCompatActivity {
    ...
    protected void onCreate(Bundle SavedInstanceState){
        ...
        setContentView(R.layout.aktivitas_dua);
        mReply = findViewById(R.id.editText_second);
        Intent muncul = getIntent();
        String isiSurat = muncul.getStringExtra(id.co.helloapps2.AktivitasSatu.EXTRA_MESSAGE);
